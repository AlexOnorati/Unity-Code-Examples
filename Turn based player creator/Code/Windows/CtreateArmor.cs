...
public class CreateArmor : EditorWindow
{
    private int health;
    private int attack;
    private int defense;
    ...
    static void Init()
    {
        CreateArmor armorWindow = (CreateArmor)EditorWindow.GetWindow(typeof(CreateArmor));
        armorWindow.Show();
    }
    ...
    void OnGUI()
    {
        ...
        if (type != ArmorType.NONE && name != null && name.Length > 0 && description != null && description.Length > 0 && image != null && GUILayout.Button("create"))
        {
