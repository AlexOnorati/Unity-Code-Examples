...
public class ViewArmor : EditorWindow
{
    private static Armor current;

    public static void Init(Armor currentArmor)
    {
        ViewArmor armorWindow = (ViewArmor)EditorWindow.GetWindow(typeof(ViewArmor));
